...
import com.stephanie.curso.services.UserService;
...
public class UserResource {
	...
	public ResponseEntity<User> findById(@PathVariable Long id){//Usamos a anotation @PathVariable para que o Spring aceite o ID e considerá-lo como parâmetro que vai chegar na url
		User obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
		//http://localhost:8080/users/1 no navegador ou no postman para visualizar
	}
}
